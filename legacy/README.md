...
These files are preserved for history only. **Do not use them for the current Detective Map V2 production workflow.**
...
Current deploy entrypoint remains in the repository root:
